...
<br>
* Please replace the first command with once that matches your system requirements and CUDA version from <a href="https://docs.rapids.ai/install/" target="_blank">the official RAPIDS installation guide</a>. 
```
